...
IL_00d3:
	{
		...
		float L_42 = __this->___rotationSpeed_8;
...
IL_011b:
	{
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_44 = __this->___charCntrl_4;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_45 = V_2;
		NullCheck(L_44);
		bool L_46;
		L_46 = CharacterController_SimpleMove_mE32A48D439878B3241E8456F8EBFAAE264BD705C(L_44, L_45, NULL);
		// }
		return;
	}
}
...
{
	{
		...
		__this->___rotationSpeed_8 = (15.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
